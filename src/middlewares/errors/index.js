  ...
  switch (error.code) {
    case errorCodes.INVALID_TYPES_ERROR:
      res
        ...
        .send({ status: "error", error: error.name, details: error.message });
      break;
    case errorCodes.DATABASE_ERROR:
      res
        ...
        .send({
          status: "error",
          error: error.name || "Ha ocurrido un error con la base de datos",
    ...
    case errorCodes.MISSING_DATA:
      res
        ...
        .send({
          status: "error",
          error: error.name || "hay datos que no han sido enviados",
          details: error.message,
        });
      break;
